...
var (
	ErrCantAddProduct     = errors.New("cant add product")
	ErrCantFindProduct    = errors.New("cant find te product")
...
func BuyItemFromCart(ctx context.Context, userCollection *mongo.Collection, userID string) error {
	...
	//added order to the userCollection
	//add items in the cart to order_list
	//empty of the cart
...
func InstantBuyer(ctx context.Context, prodCollection, userCollection *mongo.Collection, productID primitive.ObjectID, UserID string) error{
	...
	orders_details.Order_cart = make([]model.ProductUser, 0)
